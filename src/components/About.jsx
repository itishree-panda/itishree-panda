      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am a Backend Developer with around 3 years of experience in
            building secure, scalable backend systems using Node.js, Express.js,
            and MongoDB, with hands-on experience in FinTech domain across
            multiple projects. Skilled in designing and implementing API
            orchestration layers to integrate multiple internal and third-party
            services, ensuring reliable data flow, transaction integrity, and
            high performance.
          </p>
