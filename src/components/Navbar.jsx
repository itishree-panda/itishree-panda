    ...
    <>
      ...
      >
        <a href="#!">
          ...
          />
          <img
            src="./assets/navbar/logo_dark.png"
            alt="Logo"
        ...
        <div className="flex items-center gap-4">
          <button onClick={toggleTheme}>
            <img
              src="./assets/navbar/moon_icon.png"
              alt=""
              className="w-5 dark:hidden"
            />
            <img
              src="./assets/navbar/sun_icon.png"
              alt=""
          ...
          >
            Contact
            <img
              src="./assets/navbar/arrow-icon.png"
              alt=""
              className="w-3 dark:hidden"
            />
            <img
              src="./assets/navbar/arrow-icon-dark.png"
              alt=""
          ...
          <button className="block md:hidden ml-3" onClick={openMenu}>
            <img
              src="./assets/navbar/menu-black.png"
              alt=""
              className="w-6 dark:hidden"
            />
            <img
              src="./assets/navbar/menu-white.png"
              alt=""
        ...
        >
          <div className="absolute right-6 top-6" onClick={closeMenu}>
            <img
              src="./assets/navbar/close-black.png"
              alt=""
              className="w-5 cursor-pointer dark:hidden"
            />
            <img
              src="./assets/navbar/close-white.png"
              alt=""
